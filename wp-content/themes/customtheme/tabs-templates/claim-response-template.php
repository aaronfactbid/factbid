    ...
    <table class="table">
        <thead>
            ...
            <tbody>
                    ...
                    $responses = $wpdb->get_results("SELECT id_user,status,amount_paid,id_response FROM ct_response WHERE id_claim=$id_claim AND id_response_next IS NULL");
                    ...
                    if(!empty($responses)){
                        ...
                        $html = '<tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn crate-bit" data-bs-toggle="modal" data-bs-target="#responseModal" >Edit</button>';
                                echo $html;
                            ?>
                            <?php
                        $html1 .= '</td>
